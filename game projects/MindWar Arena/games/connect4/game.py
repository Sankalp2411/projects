...
from games.connect4.constants import (PLAYER_RED, PLAYER_YELLOW, FIRST_PLAYER, GAME_NOT_STARTED, GAME_RUNNING, GAME_DRAW, GAME_OVER, GAME_MODE_HUMAN_VS_HUMAN, GAME_MODE_HUMAN_VS_AI,)
