...
class MainMenuScene(Scene):
    ...
    def render(self):
        self.renderer.draw_text("MindWar Arena",(60, 40),size=54,)
        self.renderer.draw_text("Select Game",(60, 110),size=38,)
        y = 190
        for index, game_name in enumerate(self.games):
            prefix = "► " if index == self.selected_index else "  "
            self.renderer.draw_text(prefix + game_name,(80, y),size=34,)
            y += 55